...
<template>
    <div class="chat-input" @dragover.prevent @drop.prevent="handleDrop">
        ...
        <div v-if="recording" class="recording-bar">
            ...
            <a-button size="mini" status="danger" @click="stopRecording">结束并识别</a-button>
        </div>
        ...
        <div class="toolbar-row">
            <div class="toolbar-left">
                <a-tooltip :content="supportVision ? '上传图片' : '当前模型不支持视觉输入'" position="top">
                ...
                <a-tooltip content="语音输入" position="top">
                ...
                <a-tooltip content="联网搜索" position="top">
                    <a-button type="text" size="small" class="search-toggle" :class="{active: studioStore.enableSearch}"
                        ...
                        <span v-if="studioStore.enableSearch" class="search-label">联网</span>
                    </a-button>
                </a-tooltip>
            </div>
...
const placeholder = computed(() =>
    props.supportVision ? '输入消息，可粘贴或上传图片…' : '输入消息…',
)
